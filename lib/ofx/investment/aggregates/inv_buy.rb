  ...
  module Investment
    module Aggregates
      ...
      class InvBuy < Foundation
        ...
        # @return [BigDecimal] The original currency of the transaction
        ...
        # @return TODO: Document this
        attr_accessor :loan_principal

        # @return TODO: Document this
        attr_accessor :loan_interest

        # @return TODO: Document this
        attr_accessor :inv401k_source

        # @return TODO: Document this
        attr_accessor :dtpayroll

        # @return [Boolean] Whether this is a prior year contribution
        attr_accessor :prior_year_contrib
        ...
        def self.from_ofx_102(node)
          response = new({
                           ...
                           markup: OFX::Utils.to_decimal(node.search('markup').inner_text),
                           ...
                           loan_principal: node.search('loanprincipal').inner_text,
                           loan_interest: node.search('loaninterest').inner_text,
                           inv401k_source: node.search('inv401ksource').inner_text,
                           dtpayroll: node.search('dtpayroll').inner_text,
                           prior_year_contrib: node.search('prioryearcontrib').inner_text == 'Y'
                         })
