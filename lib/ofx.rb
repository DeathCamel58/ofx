...
require 'ofx/investment/transaction_type/margin_interest'
require 'ofx/investment/transaction_type/reinvest'
require 'ofx/investment/transaction_type/return_of_capital'
require 'ofx/investment/transaction_type/sell_debt'
require 'ofx/investment/transaction_type/sell_mutual_fund'
require 'ofx/investment/transaction_type/sell_option'
require 'ofx/investment/transaction_type/sell_other'
require 'ofx/investment/transaction_type/sell_stock'
require 'ofx/investment/transaction_type/split'
require 'ofx/investment/transaction_type/transfer'
